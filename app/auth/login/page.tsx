      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg shadow-xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white hover:bg-slate-100 disabled:opacity-50 text-slate-800 font-semibold rounded-lg shadow-sm border border-slate-200 transition cursor-pointer"
          >
          ...
          <div className="my-6 flex items-center gap-2">
            ...
            <span className="text-xs uppercase tracking-wider text-slate-400 font-medium">o con correo</span>
            <div className="flex-1 h-px bg-slate-700"></div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-2 pr-11 bg-slate-700 border border-slate-600 text-white placeholder-slate-500 rounded focus:outline-none focus:border-blue-500 transition"
                  required
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-200 focus:outline-none p-1 cursor-pointer transition"
                  tabIndex={-1}
