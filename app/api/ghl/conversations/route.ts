  ...
  try {
    ...
    if (conversationId || contactId) {
      ...
      if (!resolvedConversationId && contactId) {
        const searchUrl = `https://services.leadconnectorhq.com/conversations/search?locationId=${resolvedLocationId}&contactId=${contactId}`;
    ...
    const listUrl = `https://services.leadconnectorhq.com/conversations/search?locationId=${resolvedLocationId}&limit=${limit}&sortBy=last_message_date&sortOrder=desc`;
